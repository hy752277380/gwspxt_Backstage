$(function() {
	...
	var documentManage = new Vue({
		...
		methods: {
			...
			getInfo(params) {
				$.post('http://localhost:8080/gwspxt/getDocumentByState', params, function(response) {
			...
			editDocument(index) {
				...
				location.href = "http://localhost:8080/gwspxt/reviewDetailDocument";
			},
			checkDocument(index) {
            			    var lhs_check = {
            			        action:"check",
            				...
            				window.location.href = "http://localhost:8080/gwspxt/reviewDetailDocument";
            			},
